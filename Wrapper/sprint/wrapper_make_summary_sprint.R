...
eq1 <- read.csv("./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_new_full_2000_0.csv")
eq2 <- read.csv("./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_new_full_2000_500.csv")
eq3 <- read.csv("./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_new_full_2000_1000.csv")
eq4 <- read.csv("./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_new_full_2000_1500.csv")
eq5 <- read.csv("./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_new_full_2000_2000.csv")
...
write.csv(summary_eq,
          "./Data/Results/M6/New_SPRINT_Results/equity/Matchit3/EQUITY_summary.csv",
          row.names=F)   

####################################### Make ASMD Summary ######################################

smd1 <- read.csv("./Data/Results/M6/ALLHAT_Results/ASMD_new_weighted_4000_0.csv")
smd2 <- read.csv("./Data/Results/M6/ALLHAT_Results/ASMD_new_weighted_4000_500.csv")
smd3 <- read.csv("./Data/Results/M6/ALLHAT_Results/ASMD_new_weighted_4000_1000.csv")
smd4 <- read.csv("./Data/Results/M6/ALLHAT_Results/ASMD_new_weighted_4000_2000.csv")
smd5 <- read.csv("./Data/Results/M6/ALLHAT_Results/ASMD_new_weighted_4000_4000.csv")
