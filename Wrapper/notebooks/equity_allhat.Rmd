---
title: "ALLHAT Trial Equity Calculation"
...
for (CC_Size in CC_Size_list){
  ...
  write.csv(do.call("rbind", list(summary1)),
            paste('./Data/Results/M6/ALLHAT_Results/Equity/Matchit3/',eq_str,'_fulltest_', file_string_variable, sep = ""),
            row.names=F)
}
```
